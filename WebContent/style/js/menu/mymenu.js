...
function Q6MenuBar(objName, barName) {
	...
	this.colors[5] = {
			menuBgColor:"rgb(37,34,33)",
			menuBorderColor:"rgb(255,255,255)",
			menuBorderMoveColor:"rgb(255,255,255)",
			itemBgColor:"rgb(218,218,218)",////灰色
			itemBorderColor:"rgb(218,218,218)",////灰色
			itemBgMoveColor:"rgb(255,255,255)",
			itemBorderMoveColor:"rgb(255,255,255)",//子分类鼠标悬停边框色
			itemMoveColor:"rgb(255,102,0)",//子分类鼠标悬停变色
			itemColor:"rgb(0,116,199)",//子分类字体颜色
			menuBarColor:"rgb(255,255,255)", //父分类字体颜色
			menuContentColor:"rgb(76,48,0)"
		};
	this.font = {
	};
...
Q6MenuBar.prototype.toString = function() {
	...
	// menuBar的标题<div>
	str += '<div ' + this.colors[this.colorStyle].menuBgColor + ';" class="barTitle" name="barTitle"><span class="barTitleText">' + this.barName + '</span></div>\n';
	// 使用循环添加每个菜单对应的HTML代码。
...
Q6MenuBar.prototype.item2Str = function(menuItem){
	return '<div style="border:0px solid ' + this.colors[this.colorStyle].itemBorderColor + ';background-color:' + this.colors[this.colorStyle].itemBgColor + '; color:' + this.colors[this.colorStyle].itemColor + ';" class="menuItem" onMouseMove="' + this.obj + '.itemMouseMove(this)" onMouseOut="' + this.obj + '.itemMouseOut(this)" onClick="skip(\'' + menuItem.url + '\', \'' + menuItem.frameName + '\')">' + menuItem.menuItemName + '</div>\n';
}
