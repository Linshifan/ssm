...
a:hover {color:#FF6600; text-decoration: underline;}
  ...
  <c:choose>
  	<c:when test="${code eq 'success' }">
  		<c:set var="img" value="/style/images/duihao.jpg"/>
  		<c:set var="title" value="成功"/>
  	</c:when>
  	<c:when test="${code eq 'error' }">
  		<c:set var="img" value="/style/images/cuohao.png"/>
...
<h1 style="text-align: center;margin-top: 10px;"><a href="/JustDoit/order/myOrders">返回订单页</a></h1>
