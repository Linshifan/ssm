...
<html>
  <head>
	...
	-->
	<link rel="stylesheet" type="text/css" href="<c:url value='/style/css/cart/showitem.css'/>">
...
<script type="text/javascript">
  ...
  <c:choose>
  	...
  	<c:otherwise>
<form id="form1" action="/JustDoit/order/createOrder" method="post">
...
<c:forEach items="${cartItemList }" var="cartItem">
	...
	<tr>
		<td colspan="6">
			<input id="addr" type="text" name="address" value="福州市 鼓楼区 西街镇 福发大楼 一楼前台"/>
		</td>
	</tr>
	<tr>
