...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="<c:url value='/style/css/qianduan/css.css'/>">
	<link rel="stylesheet" type="text/css" href="<c:url value='/style/css/user/pwd.css'/>">
	<script type="text/javascript" src="<c:url value='/style/jquery/jquery-1.5.1.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/style/js/user/pwd.js'/>"></script>
  </head>
  ...
  <body>
	...
	<div class="div1">
		<form id="pwdform" action="/JustDoit/updatePassword" method="post" target="_top">
		<table>
			<tr>
